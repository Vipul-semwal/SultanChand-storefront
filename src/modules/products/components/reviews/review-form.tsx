...
const ProductReviewForm = ({ prouduct_id }: { prouduct_id: string }) => {
  ...
  return (
    <div className="max-w-lg mx-auto p-6  focus:ring-orange-500 shadow-lg rounded-lg">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={isPending}
          className={`w-full bg-orange-600 text-white py-2 px-4 rounded-md transition ${
            isPending ? "opacity-50 cursor-not-allowed" : "hover:bg-orange-700"
          }`}
        >
